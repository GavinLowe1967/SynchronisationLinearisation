...
linearisability if and only if each individual object does.   We
...
simultaneously (such as those in a synchronisation).  They then define CAL in
terms of those CA traces, in a way that is equivalent to our definition.
Unlike us, they do not provide a way of specifying correct CA-traces,
comparable to out synchronisation specification objects: they simply assume a

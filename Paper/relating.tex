...
\draw[|-|] (0,0) -- node[above] {$\sm{send}^1(3)\::()$} (5,0);
\draw (1, 0) \X; \draw(4,0) \X;
\draw[|-|] (2,-1) -- node[above] {$\sm{receive}^2(())\::3$} (6,-1);
\draw(3,-1) \X;
\end{tikzpicture}
\end{center}

...
\end{scala}
%
The idea is that the operation |op|\s1 on the synchronisation object will be
linearised by the composition of the two operations |op|\s1 and
$\overline{\sm{op}}_1$; but operation |op|\s2 on the synchronisation object
will be linearised by just the operation |op|\s2 of the specification object,
...
log for operations~|op|\s1 and $\overline{\sm{op}}_1$. 
%%  (Alternatively, we

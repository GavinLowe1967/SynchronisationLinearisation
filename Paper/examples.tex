...
threads ran concurrently, one sending, one receiving, and one closing the
channel, it was possible for the receiver to return as if it had synchronised,
...
duration, and just leave the tests running.

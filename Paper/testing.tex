...
% sync 1 and 2
\draw (1.9,0) \X; \draw (1.9,\ya) \X; \draw[dashed] (1.9,0) -- (1.9,\ya); 
% op_1^3
\def\yb{-3.0}
...
\def\yd{-6.0}
\twoStep(1.9,\yd){$\op_1^1(x_1)\::()\; \op_2^2(x_2)\::y_2$}
\crossAt(10.5,\yd){$\overline{\op}_1^1()\::y_1$}
\twoStep(5.6,\yd){$\op_1^3(x_3)\::()\; \op_2^4(x_4)\::y_4$}
\crossAt(9.0,\yd){$\overline{\op}_1^3()\::y_3$}
\end{tikzpicture}
\end{center}

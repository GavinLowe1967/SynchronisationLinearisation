...
|(0,2)|, and |syncC(2)| returning |(0,1)|) did not
...
%\subsection*{Progressibility}

Similarly, if a tester finds a failure of synchronisation progressibility, it
displays the history.  Below is such a history for a faulty synchronous
channel.
%
\begin{verbatim}
0:   Call of Send(48)
...
\end{verbatim}
%
Here executions~0 and 1 have successfully synchronised.  However, executions~2
and~3 have failed to synchronise when they should have done.
